...
const AccountCard = ({ data }) => {
  function cardColor() {
    switch (data.th) {
      case "151":
        return { bg: "rgba(32,28,60,.95)", color: "#f2f2f2" };
        break;
      case "152":
        return { bg: "rgba(32,28,60,.95)", color: "#f2f2f2" };
        break;
      ...
      case "155":
        ...
        break;
      case "141":
        return { bg: "rgba(61,130,82,.95)", color: "#f2f2f2" };
        break;
      case "142":
        return { bg: "rgba(61,130,82,.95)", color: "#f2f2f2" };
        break;
      ...
      case "145":
        ...
        break;
      case "131":
        return { bg: "rgba(6,76,85,.95)", color: "#f2f2f2" };
        break;
      case "132":
        return { bg: "rgba(6,76,85,.95)", color: "#f2f2f2" };
        break;
      ...
      case "135":
        ...
        break;
      case "121":
        return { bg: "rgba(12,60,113,.95)", color: "#f2f2f2" };
        break;
      case "122":
        return { bg: "rgba(12,60,113,.95)", color: "#f2f2f2" };
        break;
      ...
      case "125":
        ...
        break;
      case "11":
        return { bg: "rgba(124,113,96,.95)", color: "#f2f2f2" };
        break;
      case "10":
        return { bg: "rgba(124,35,29,.95)", color: "#f2f2f2" };
        break;
      case "9":
        return { bg: "rgba(37,36,41,.95)", color: "#f2f2f2" };
        break;
    }
  }
